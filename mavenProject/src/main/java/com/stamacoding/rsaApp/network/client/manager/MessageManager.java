package com.stamacoding.rsaApp.network.client.manager;
...
/**
 * Manages all messages that have to get stored or updated in collaboration with the {@link ChatDatabaseService}. Provides methods to filter messages by their attributes.
 */
