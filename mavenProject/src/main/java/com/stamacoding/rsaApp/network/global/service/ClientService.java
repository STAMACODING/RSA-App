...
public abstract class ClientService extends IOService{
	private Socket socketConnection;
	private int port;
	private String serverIp;

	protected ClientService(String serverIp, int port) {
	...
	protected void setSocketConnection(Socket serverConnection) {
