...
public class MessageDatabaseManager{
	...
	private volatile static MessageDatabaseManager singleton = new MessageDatabaseManager();
	
	/**
	 *  Creates an instance of this class. Gets automatically called once at the start to define the manager's {@link #singleton}. Use {@link MessageDatabaseManager#getInstance()} to get the
	...
	public Message[] getMessagesFromDB(){
		try {
			Connection con = MessageDatabaseManager.getInstance().connect();
	...
	public static void main(String [] args) throws Exception {
		Message[] messages = MessageDatabaseManager.getInstance().getMessagesFromDB();
	}
